// GENERATED AUTOMATICALLY FROM 'Assets/Settings/Default Input Actions/XRI Default Input Actions.inputactions'
...
namespace Input
{
    ...
    ""controlSchemes"": [
        ...
        public struct XRIHMDActions
        {
            ...
            public XRIHMDActions(@InputActions wrapper) { m_Wrapper = wrapper; }
