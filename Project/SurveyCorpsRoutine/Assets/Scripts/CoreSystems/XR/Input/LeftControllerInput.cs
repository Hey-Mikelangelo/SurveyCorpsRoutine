...
{
    internal class LeftControllerInput : XR_InputActions.ILeftHandActions, IXRActionReceiver
    {
        ...
        public event UnityAction<InputAction.CallbackContext> onPrimaryAxisClick;
        ...
        public event UnityAction<InputAction.CallbackContext> onPrimaryAxisTouch;
        ...
        {
            onPrimaryAxisClick?.Invoke(context);
        }
        ...
        {
            onPrimaryAxisTouch?.Invoke(context);
        }
