...
{
    public class XR_InputActions : IInputActionCollection, IDisposable
    {
        public InputActionAsset asset { get; }
        public XR_InputActions()
        {
    ...
    ""controlSchemes"": []
        ...
        {
            private XR_InputActions m_Wrapper;
            public HMDActions(XR_InputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private XR_InputActions m_Wrapper;
            public RightHandActions(XR_InputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private XR_InputActions m_Wrapper;
            public LeftHandActions(XR_InputActions wrapper) { m_Wrapper = wrapper; }
